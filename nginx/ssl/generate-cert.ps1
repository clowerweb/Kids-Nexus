# PowerShell script to create self-signed certificate for kidsnexus.local
$ErrorActionPreference = "Stop"

# Certificate details
$domain = "kidsnexus.local"
$certPath = ".\kidsnexus.local.crt"
$keyPath = ".\kidsnexus.local.key"
